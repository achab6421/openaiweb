    ...
    <div class="battle-container">
        ...
        <div class="battle-content">
            ...
            <div class="battle-section">
                <div id="options-area" style="background: #222; color: #fff; border-radius: 8px; padding: 16px;"></div>
            ...
            $.get(url)
                .done(function(data) {
                    ...
                    if (data.options_arr && Object.keys(data.options_arr).length > 0) {
                        ...
                        html += '<div class="card-body" style="background:#222!important;color:#fff!important;">';
                        html += '<form class="mt-2"><div class="row">';
                        for (const label in data.options_arr) {
                            html += `<div class="col-md-6 mb-3">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label w-100" for="option${label}" style="color:#fff;">
                                        <span class="fw-bold">${label}.</span>
                                        <pre class="mb-0 text-start" style="background:#111;border-radius:4px;padding:8px;color:#fff;">${data.options_arr[label]}</pre>
                                    </label>
                                </div>
                            </div>`;
                        }
