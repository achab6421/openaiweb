    ...
    <div class="container">
        <div class="maze-container">
            ...
            <div class="maze-levels">
                <div class="maze-level <?php echo $current_level < 2 ? 'locked' : ''; ?>" onclick="<?php echo $current_level >= 2 ? 'location.href=\'maze_level.php?level=1\'' : ''; ?>">
                ...
                <div class="maze-level <?php echo $current_level < 4 ? 'locked' : ''; ?>" onclick="<?php echo $current_level >= 4 ? 'location.href=\'maze_level.php?level=2\'' : ''; ?>">
                    <div class="maze-pattern"></div>
                ...
                <div class="maze-level <?php echo $current_level < 6 ? 'locked' : ''; ?>" onclick="<?php echo $current_level >= 6 ? 'location.href=\'maze_level.php?level=3\'' : ''; ?>">
                    <div class="maze-pattern"></div>
                ...
                <div class="maze-level <?php echo $current_level < 8 ? 'locked' : ''; ?>" onclick="<?php echo $current_level >= 8 ? 'location.href=\'maze_level.php?level=4\'' : ''; ?>">
                    <div class="maze-pattern"></div>
