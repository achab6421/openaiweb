...
$dungeon_id = intval($_POST['dungeon_id'] ?? 0); // 從表單取得副本 ID
...
$stmt = $pdo->prepare("INSERT INTO teams (invite_code, max_members, is_public, room_name, dungeon_id) VALUES (?, ?, ?, ?, ?)");
if (!$stmt->execute([$invite_code, $max_players, $is_public, $room_name, $dungeon_id])) {
